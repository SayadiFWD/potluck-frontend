...
export const UPDATE_FORM_EVENT = "UPDATE_FORM_EVENT";
export const SUBMIT_FORM_EVENT = "SUBMIT_FORM_EVENT";
export const UPDATE_FORM_FOOD = "UPDATE_FORM_FOOD";
export const SUBMIT_FORM_FOOD = "SUBMIT_FORM_FOOD";